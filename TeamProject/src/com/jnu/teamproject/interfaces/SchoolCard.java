...
public class SchoolCard extends JFrame {
	...
	public SchoolCard() {
		...
		lblNewLabel_2.setForeground(UIManager.getColor("CheckBoxMenuItem.acceleratorForeground"));
		...
		button.setFont(new Font("ι»‘δ½“", Font.PLAIN, 12));
		button.setBounds(463, 61, 77, 23);
		contentPane.add(button);
		
		JLabel label_3 = new JLabel("\u5B66\u751F\u751F\u6D3B");
		label_3.setForeground(Color.BLACK);
		label_3.setFont(new Font("ι»‘δ½“", Font.BOLD, 15));
		label_3.setBounds(46, 93, 71, 32);
		...
		label_4.setFont(new Font("ι»‘δ½“", Font.PLAIN, 12));
		label_4.setBounds(123, 102, 488, 15);
		...
		label_2.setFont(new Font("ι»‘δ½“", Font.BOLD, 13));
		...
		JButton button_1 = new JButton("\u6302 \u5931");
		button_1.setForeground(UIManager.getColor("CheckBoxMenuItem.acceleratorForeground"));
		button_1.setBackground(UIManager.getColor("CheckBox.shadow"));
		button_1.setFont(new Font("ΊΪΜε", Font.PLAIN, 12));
		button_1.setBounds(179, 166, 93, 23);
		contentPane.add(button_1);
		
		JLabel label_5 = new JLabel("\u5145\u503C\u60C5\u51B5\uFF1A");
		label_5.setForeground(new Color(0, 0, 0));
		label_5.setFont(new Font("ι»‘δ½“", Font.BOLD, 13));
